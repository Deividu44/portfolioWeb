    ...
    <>
      ...
      <div className='mt-4'>
        <p className='fs-4 lh-sm text-content mb-5'>
          ...
          y estuve trabajando durante un año en una consultoría como programador informático.
        ...
        <p className='fs-3 lh-sm text-content mt-5'>
          ... y sigo aprendiendo con el curso de FullStackOpen
        </p>
      </div>
    </>
  )
